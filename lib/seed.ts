...
export const seedPhases: ProjectPhase[] = [
    ...
    tasks: [
      {
        ...
        definitionOfDone: 'Memory persists across sessions, durable vs contextual separation works, operator can review and edit memories.',
      },
      {
        id: 'p2-t2',
        title: 'Voice calibration and style guide',
        status: 'completed',
        owner: 'lana',
        priority: 'high',
        definitionOfDone: 'Voice sample set A/B tested, variant selected, style guide documented, Lana consistently writes in correct voice.',
      },
      {
        id: 'p2-t3',
        ...
        owner: 'shared',
        priority: 'high',
        definitionOfDone: 'Lana can search web + curated sources, extract key findings, synthesize into structured research notes in her voice. Tested on 3 real design/architecture topics with output quality verified.',
        notes: 'Approach: web search (broad) + curated source list (deep). lana-research skill created. Weekly cron job set.',
      },
      {
        id: 'p2-t4',
      ...
      },
      {
        ...
        owner: 'shared',
        priority: 'medium',
        definitionOfDone: '50+ durable knowledge entries across design history, architectural movements, material culture, key thinkers. Structured, searchable, referenced.',
        dependsOn: ['p2-t3'],
      },
      {
        id: 'p2-t6',
        title: 'Taste system calibration',
        status: 'not_started',
        owner: 'lana',
        priority: 'medium',
        definitionOfDone: '20 scored reference examples (good/bad) across content types. Taste system returns quality scores within ±10% of operator judgment.',
        dependsOn: ['p2-t5'],
      },
    ],
  ...
  },
  {
    ...
    tasks: [
      {
        id: 'p3-t1',
        title: 'Design heartbeat loop architecture',
        status: 'completed',
        owner: 'operator',
        priority: 'high',
        definitionOfDone: 'Loop types defined, triggers specified, output formats designed, storage destinations configured.',
      },
      {
        id: 'p3-t2',
        title: 'Daily reflection loop',
        status: 'in_progress',
        owner: 'lana',
        priority: 'high',
        definitionOfDone: 'Runs every day autonomously for 7 consecutive days. Each run produces a structured reflection note. Voice drift detection works.',
      },
      {
        id: 'p3-t3',
        title: 'Weekly research loop',
        status: 'in_progress',
        owner: 'lana',
        priority: 'high',
        definitionOfDone: 'Runs every Monday autonomously. Uses lana-research skill to scan sources, extract key findings, produce research notes. 2 consecutive successful weekly runs.',
        notes: 'lana-research skill created. Cron job 813c58f06658 scheduled for Mondays 9am.',
        dependsOn: ['p2-t3'],
      },
      {
        id: 'p3-t4',
        title: 'Opportunity scan loop',
        status: 'not_started',
        owner: 'shared',
        priority: 'medium',
        definitionOfDone: 'Runs weekly. Identifies brands, publications, or people relevant to Lana monetization. Produces 3+ real opportunity flags per scan.',
        dependsOn: ['p3-t3'],
      },
      {
        id: 'p3-t5',
        title: 'Deviation detection and alerting',
        status: 'not_started',
        owner: 'operator',
        priority: 'low',
        definitionOfDone: 'System detects significant deviations in voice, quality, or behavior and alerts operator. False positive rate under 20%.',
        dependsOn: ['p3-t2'],
      },
    ],
